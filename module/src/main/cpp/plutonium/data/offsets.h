namespace offsets {
    ...
    constexpr ::std::ptrdiff_t TouchScreenKeyboard$$Open = 0x49B5658;
    constexpr ::std::ptrdiff_t TouchScreenKeyboard$$get_text = 0x49B579C;
    ...
    constexpr ::std::ptrdiff_t GetClassByTypeInfo1 = 0x20EF728;
    constexpr ::std::ptrdiff_t GenerateTypeInfo1 = 0x20EF4B0;

    //constexpr ::std::ptrdiff_t BombManager$$GetBombSite = 0x2222C38;
    //constexpr ::std::ptrdiff_t BombManager$$GetBombPosition = 0x2223268;

    constexpr ::std::ptrdiff_t AnimationCurve$$Evaluate = 0x497A8A4;
    ...
    constexpr ::std::ptrdiff_t il2cpp_method_get_param_name_0 = 0x213BBF0;
    ...
    constexpr ::std::ptrdiff_t get_instance_method = 0x513BAF8;
    constexpr ::std::ptrdiff_t CTOR = 0x3968B90;
    constexpr ::std::ptrdiff_t method_info2 = 0x516A2C8;
    ...
    constexpr ::std::ptrdiff_t cur_time = 0x49B4FE4;

    constexpr ::std::ptrdiff_t SET_RESOLUTION = 0x49877E8;
    constexpr ::std::ptrdiff_t get_rect = 0x49B6990;
    ...
    constexpr ::std::ptrdiff_t Button$$Press = 0x4A8443C;
    constexpr ::std::ptrdiff_t PhotonNetwork$$get_time = 0x23E3AF8;
    constexpr ::std::ptrdiff_t TMP_InputField$$get_clipboard = 0x492D574;
